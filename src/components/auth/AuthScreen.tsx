      ...
      <div className="hidden w-1/2 flex-col justify-between bg-brand-700 p-12 text-white lg:flex">
        ...
        <div>
          ...
          <p className="mt-5 max-w-md text-brand-100">
            Your personal academic command center. Organize classes and assignments, understand
            priorities, and get a realistic daily plan built around your real schedule.
          </p>
        </div>
        <div className="flex gap-8 text-sm text-brand-100">
          <div>
            <div className="font-display text-2xl font-bold text-white">Prioritize</div>
            what to do first
          </div>
          <div>
            <div className="font-display text-2xl font-bold text-white">Plan</div>
            around real life
          </div>
          <div>
            <div className="font-display text-2xl font-bold text-white">Improve</div>
            your grades
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        <div className="w-full max-w-sm animate-fade-in">
          <div className="mb-8 flex items-center gap-2 lg:hidden">
            ...
            <span className="font-display text-lg font-semibold text-slate-900">Academic Compass</span>
          </div>
